...
struct HomeView: View {
    ...
    private var buttonOrder: String = "metronome_settings, memoaid_settings"
    ...
    private func collapsedCircle(item: String) -> some View {
        ZStack {
            ...
            VStack(spacing: 8) {
                ...
                if item == "memoaid_settings" {
                    Image(systemName: "brain.head.profile")
                        .resizable()
                        .scaledToFit()
                        .frame(width: 45, height: 45)
                        .foregroundColor(.purple)
                } else if item == "metronome_settings" {
    ...
    private func expandedContent(item: String,
        ...
        VStack {
            ...
            if item == "metronome_settings" {
                SwingingMetronome(angle: metronomeAngle)
                    .frame(width: 150, height: 150)
            } else if item == "memoaid_settings" {
                Image(systemName: "brain.head.profile")
                    .resizable()
                    .scaledToFit()
                    .frame(width: 150, height: 150)
